...
def test_add_contact(app):
    ...
    contact = Contact(firstname="ivanov", middlename="ivan", lastname="IVAN", address="Moscow", phonehome="775-459",
                      phonemobile="9434", phonework="958-753", phonefax="555-667", email="as@mail.ru")
